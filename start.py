    ...
    def execute(self):
        if self.sim.gui:
            ...
            input_dialog.geometry(
                f"+{self.sim.gui.root.winfo_rootx() + self.sim.gui.root.winfo_width()
                    // 2 - input_dialog.winfo_reqwidth() // 2}"
                f"+{self.sim.gui.root.winfo_rooty() + self.sim.gui.root.winfo_height()
                    // 2 - input_dialog.winfo_reqheight() // 2}")
